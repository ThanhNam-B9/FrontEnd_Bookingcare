...
class ModalAddUser extends Component {
  ...
  handleAddNewUser = (data) => {
    ...
    if (isValidInput === true) {
      ...
      // this.setState({
      //   email: "",
      //   password: "", // nên dùng emitter , khi user nhập temail đã ca+ó trong hệ thống thì k bị reset input , dễ dàng trong việc sửa lại email
      //   firstName: "",
      //   lastName: "",
      //   address: "",
      // });
  ...
  // handleOnChaneInput = (event, id // truyên thêm name trong OnChange ) => {
  //   let conpyState = { ...this.state };
  //   conpyState[id] = event.target.value;
  //   this.setState({
  //     ...conpyState,
  //   });
  // };
